...
class Account:
    ...
    def __init__(
        ...
        # increase next_id for the next object of Account
        Account.next_id += 1
        self.name = name
        # balance at creation of the account
        self.init_balance = init_balance
        # balance now
        self.balance = init_balance
        self.transactions = []
        # interest_pa=0.01 for 1% note: negative interests are supported
    ...
    def update_interest(self, actual_date=dt.date.today()):
        ...
        while actual_date > self.interest_date:
            ...
            while i_date < (add_months(self.interest_date, 1)
                            - dt.timedelta(days=1)):
